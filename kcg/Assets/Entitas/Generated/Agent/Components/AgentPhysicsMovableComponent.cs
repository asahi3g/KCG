...
public partial class AgentEntity {
    ...
    public void ReplacePhysicsMovable(float newSpeed, KMath.Vec2f newVelocity, KMath.Vec2f newAcceleration, bool newAffectedByGravity, bool newAffectedByGroundFriction, bool newInvulnerable, bool newOnGrounded, bool newSlidingRight, bool newSlidingLeft, bool newDroping, bool newWantToDrop) {
        var index = AgentComponentsLookup.PhysicsMovable;
        var component = (Physics.MovableComponent)CreateComponent(index, typeof(Physics.MovableComponent));
        component.Speed = newSpeed;
        component.Velocity = newVelocity;
