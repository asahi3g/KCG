...
namespace Inventory
{
    public class MouseSelectionSystem
    {
        ...
        public void InventoryPosCalculation(InventoryEntity inventoryEntity, ref float x, ref float y, ref float w, ref float h, ref Vec2f tileSize)
        {
        ...
        public void OnUpdate(Contexts contexts)
        {
            if (MouseDown == false)
                return;
            ...
            GameState.Renderer.DrawSpriteGui(pos.X, pos.Y, 45f / 1080f, 45f / 1080f, sprite);
        }
    }
}
