...
namespace KGUI.Elements
{
    public class ElementSpawnerSystem
    {
            ...
            Vec2f position, Vec2f areaSize, int Index, Enums.ElementType elementType)
        {
            ...
            textWrapperObj.Create("UIElementText", entity.kGUIElementsText.Text, UnityEngine.GameObject.Find("Canvas").transform, entity.kGUIElementsText.TimeToLive);
            textWrapperObj.SetSizeDelta(new UnityEngine.Vector2(areaSize.X, areaSize.Y));
