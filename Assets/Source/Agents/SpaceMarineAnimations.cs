namespace Agent
{
    ...
    public partial class AgentMovementAnimationTable
    {
        ...
        public void InitSpaceMarineAnimations()
        {
            ...
            SetAnimation(Enums.AgentMovementState.Crouch_MoveBackward, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.Default, 
            ...
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineRifleIdleAlerted, FadeTime=0.125f, Looping = false, Speed = 1.0f, StartTime = 0.43f, MovementSpeedFactor = 0.0f});
             ...
             SetAnimation(Enums.AgentMovementState.Rolling, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingRifle, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineRoll, FadeTime=0.125f, Looping = false, Speed = 1.5f, MovementSpeedFactor = 0.0f});

            SetAnimation(Enums.AgentMovementState.StandingUpAfterRolling, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingRifle, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineIdle, FadeTime=1.425f, Looping = false, Speed = 1.0f, MovementSpeedFactor = 0.0f});
            ...
            SetAnimation(Enums.AgentMovementState.Crouch_MoveBackward, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingRifle, 
            ...
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineRifleFireGun, FadeTime=999.075f, Looping = true, Speed = 0.6f, MovementSpeedFactor = 0.1f, UseActionDurationForSpeed = true});
            ...
            SetAnimation(Enums.AgentMovementState.Idle, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            ...
            SetAnimation(Enums.AgentMovementState.IdleAfterShooting, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarinePistolIdleAlerted, FadeTime=0.125f, Looping = false, Speed = 1.0f, StartTime = 0.43f, MovementSpeedFactor = 0.0f});
             ...
             SetAnimation(Enums.AgentMovementState.Rolling, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineRoll, FadeTime=0.125f, Looping = false, Speed = 1.5f, MovementSpeedFactor = 0.0f});

            SetAnimation(Enums.AgentMovementState.StandingUpAfterRolling, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineIdle, FadeTime=1.425f, Looping = false, Speed = 1.0f, MovementSpeedFactor = 0.0f});

            SetAnimation(Enums.AgentMovementState.Crouch, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            ...
            SetAnimation(Enums.AgentMovementState.Crouch_Move, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarinePistolCrouch_Walk, FadeTime=0.125f, Looping = true, Speed = 1.0f, MovementSpeedFactor = 0.0f});

            SetAnimation(Enums.AgentMovementState.Crouch_MoveBackward, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineCrouch_WalkBackwards, FadeTime=0.125f, Looping = true, Speed = 1.0f, MovementSpeedFactor = 0.0f});

            SetAnimation(Enums.AgentMovementState.Jump, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            ...
            SetAnimation(Enums.AgentMovementState.Flip, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            ...
            SetAnimation(Enums.AgentMovementState.Falling, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            ...
            SetAnimation(Enums.AgentMovementState.Limp, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineLimp, FadeTime=0.125f, Looping = true, Speed = 1.0f, MovementSpeedFactor = 0.0f});
            ...
            SetAnimation(Enums.AgentMovementState.SlidingRight, Enums.AgentAnimationType.SpaceMarineAnimations, Enums.ItemAnimationSet.HoldingPistol, 
            new AgentAnimation{Animation=Engine3D.AnimationType.SpaceMarineSliding, FadeTime=0.125f, Looping = true, Speed = 1.0f, MovementSpeedFactor = 0.0f});
