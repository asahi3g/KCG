...
namespace Animation
{
    public class AnimationManager
    {
        ...
        public void InitializeResources()
        {
            ...
            int SwordSlash_1_Up_Right_SpriteSheet = GameState.SpriteLoader.GetSpriteSheetID("Assets\\StreamingAssets\\BakedEffects\\Sword_Slash_1_Up_Right.png", 50, 66);
            int SwordSlash_2_Up_Right_SpriteSheet = GameState.SpriteLoader.GetSpriteSheetID("Assets\\StreamingAssets\\BakedEffects\\Sword_Slash_2_Up_Right.png", 63, 51);
            int SwordSlash_3_Up_Right_SpriteSheet = GameState.SpriteLoader.GetSpriteSheetID("Assets\\StreamingAssets\\BakedEffects\\Sword_Slash_3_Up_Right.png", 50, 70);
            ...
            int SwordSlash_1_Up_RightBaseSpriteId = GameState.SpriteAtlasManager.CopySpritesToAtlas(SwordSlash_1_Up_Right_SpriteSheet, 0, 0, 2, 0, Enums.AtlasType.Particle);
            int SwordSlash_2_Up_RightBaseSpriteId = GameState.SpriteAtlasManager.CopySpritesToAtlas(SwordSlash_2_Up_Right_SpriteSheet, 0, 0, 2, 0, Enums.AtlasType.Particle);
            int SwordSlash_3_Up_RightBaseSpriteId = GameState.SpriteAtlasManager.CopySpritesToAtlas(SwordSlash_3_Up_Right_SpriteSheet, 0, 0, 2, 0, Enums.AtlasType.Particle);
            ...
            GameState.AnimationManager.CreateAnimation((int)AnimationType.SwordSlash_1_Up_Right);
            GameState.AnimationManager.SetTimePerFrame(0.075f);
            GameState.AnimationManager.SetBaseSpriteID(SwordSlash_1_Up_RightBaseSpriteId);
            GameState.AnimationManager.SetFrameCount(3);
            GameState.AnimationManager.EndAnimation();

            GameState.AnimationManager.CreateAnimation((int)AnimationType.SwordSlash_2_Up_Right);
            GameState.AnimationManager.SetTimePerFrame(0.075f);
            GameState.AnimationManager.SetBaseSpriteID(SwordSlash_2_Up_RightBaseSpriteId);
            GameState.AnimationManager.SetFrameCount(3);
            GameState.AnimationManager.EndAnimation();

            GameState.AnimationManager.CreateAnimation((int)AnimationType.SwordSlash_3_Up_Right);
            GameState.AnimationManager.SetTimePerFrame(0.075f);
            GameState.AnimationManager.SetBaseSpriteID(SwordSlash_3_Up_RightBaseSpriteId);
            GameState.AnimationManager.SetFrameCount(3);
            GameState.AnimationManager.EndAnimation();
        }
