...
namespace Node
{
    public class ThrowGasBombAction : NodeBase
    {
        ...
        public override void OnEnter(NodeEntity nodeEntity)
        {
            ...
            ProjectileEntity projectileEntity = GameState.Planet.AddProjectile(startPos, new Vec2f(x - startPos.X, y - startPos.Y).Normalized, ProjectileType.GasGrenade, agentEntity.agentID.ID, false);
