...
namespace AI.Movement
{
    public class PathFinding
    {
        ...
        readonly PathAdjacency[] directions = new PathAdjacency[8]
            {   new() { dir = new Vec2i(1, 0),  cost = 100 },   // Right
                new() { dir = new Vec2i(-1, 0), cost = 100 },   // Left
                new() { dir = new Vec2i(0, 1),  cost = 100 },   // Up
                new() { dir = new Vec2i(0, -1), cost = 100 },   // Down
                // Used for flying paths only
                new() { dir = new Vec2i(1, 1), cost = 144 },    // Up - Right
                new() { dir = new Vec2i(-1, 1), cost = 144 },   // Up - Left
                new() { dir = new Vec2i(1, -1), cost = 144 },   // Down - Right
                new() { dir = new Vec2i(-1, -1), cost = 144 }    // Down - Left
            };
