...
namespace Node
{
    ...
    {
        public override ActionType  Type => ActionType .ThrowFlareAction;
        ...
        public override void OnEnter(NodeEntity nodeEntity)
        {
            ...
            planet.AddProjectile(startPos, new Vec2f(x - startPos.X, y - startPos.Y).Normalized, ProjectileType.Flare, agentEntity.agentID.ID, false);
