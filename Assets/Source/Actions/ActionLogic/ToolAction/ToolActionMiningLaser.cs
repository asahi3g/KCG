...
namespace Action
{
    public class ToolActionMiningLaser : ActionBase
    {
        public ToolActionMiningLaser(Contexts entitasContext, int actionID) : base(entitasContext, actionID)
        { 
    ...
    // Factory Method
    public class ToolActionMiningLaserCreator : ActionCreator
    {
        public override ActionBase CreateAction(Contexts entitasContext, int actionID)
        {
            return new ToolActionMiningLaser(entitasContext, actionID);
        }
    }
}
