...
namespace KGUI
{
    public class OxygenElementUI : ElementUI
    {
        ...
        public override void Init()
        {
            ...
            oxygenAmount = GameState.Planet.Player != null ? GameState.Planet.Player.agentStats.Oxygen : 0;
        ...
        public override void Update()
        {
            ...
            oxygenAmount = planet.Player != null ? planet.Player.agentStats.Oxygen : 0;
