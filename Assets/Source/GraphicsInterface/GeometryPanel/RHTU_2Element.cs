...
namespace KGUI
{
	...
	public class RHTU_2Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
            ...
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.L1_R6_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.L1_R6_Metal;
			Toggle(true);
		}
