...
{
	// row 25, column 19
	public class HSQ_3Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
			...
			ID = ElementEnums.HSQ_3;
            
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.HP_R3_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.HP_R3_Metal;
			Toggle(true);
		}
