...
namespace KGUI
{
	...
	public class TO_3Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
            ...
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.TB_R3_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.TB_R3_Metal;
			Toggle(true);
		}
