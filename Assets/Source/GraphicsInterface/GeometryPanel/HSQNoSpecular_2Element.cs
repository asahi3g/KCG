...
{
	// row 5, column 3
	public class HSQNoSpecular_2Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
			...
			ID = ElementEnums.HSQNoSpecular_2;
            
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.HB_R2_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.HB_R2_Metal;
			Toggle(true);
		}
