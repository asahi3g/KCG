...
{
	// row 5, column 13
	public class RCSQ_0Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
			...
			ID = ElementEnums.RCSQ_0;
            
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.L2_R4_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.L2_R4_Metal;
			Toggle(true);
		}
