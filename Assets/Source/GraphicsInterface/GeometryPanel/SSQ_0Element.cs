...
namespace KGUI
{
	public class SSQ_0Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
            ...
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.QP_R0_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.QP_R0_Metal;
			Toggle(true);
		}
