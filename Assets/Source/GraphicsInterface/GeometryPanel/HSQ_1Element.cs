...
namespace KGUI
{
	...
	public class HSQ_1Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
            ...
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.HP_R1_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.HP_R1_Metal;
			Toggle(true);
		}
