...
{
	// row 16, column 17
	public class SSQ_3Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
			...
			ID = ElementEnums.SSQ_3;
            
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.QP_R3_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.QP_R3_Metal;
			Toggle(true);
		}
