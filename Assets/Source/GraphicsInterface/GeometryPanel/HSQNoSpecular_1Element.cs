...
{
	// row 3, column 3
	public class HSQNoSpecular_1Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
			...
			ID = ElementEnums.HSQNoSpecular_1;
            
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.HB_R1_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.HB_R1_Metal;
			Toggle(true);
		}
