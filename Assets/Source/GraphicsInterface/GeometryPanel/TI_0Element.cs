...
{
	// row 1, column 5
	public class TI_0Element : ElementUI, IToggleElement
	{
		...
		public override void Init()
		{
			...
			ID = ElementEnums.TI_0;
            
            var tileProperty = GameState.TileCreationApi.GetTileProperty(Enums.PlanetTileMap.TileID.TB_R0_Metal);
		...
		public override void OnMouseClick()
		{
			...
			item.itemTile.TileID = Enums.PlanetTileMap.TileID.TB_R0_Metal;
			Toggle(true);
		}
