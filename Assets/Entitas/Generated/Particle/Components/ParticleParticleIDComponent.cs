...
public partial class ParticleEntity {
    ...
    public void AddParticleID(long newID, int newIndex, Particle.ParticleType newParticleType) {
    ...
    public void ReplaceParticleID(long newID, int newIndex, Particle.ParticleType newParticleType) {
        var index = ParticleComponentsLookup.ParticleID;
        var component = (Particle.IDComponent)CreateComponent(index, typeof(Particle.IDComponent));
        component.ID = newID;
        component.Index = newIndex;
