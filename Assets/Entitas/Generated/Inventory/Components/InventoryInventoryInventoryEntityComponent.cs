...
public partial class InventoryEntity {
    ...
    public void AddInventoryInventoryEntity(int newIndex, int newInventoryEntityTemplateID, Inventory.Slot[] newSlots, int newSelectedSlotID, Utility.BitSet newSlotsMask, Enums.InventoryEntityType newInventoryType) {
        ...
        component.SetSelectedSlotIndex(newSelectedSlotID);
        component.SlotsMask = newSlotsMask;
        component.InventoryType = newInventoryType;
        AddComponent(index, component);
    }

    public void ReplaceInventoryInventoryEntity(int newIndex, int newInventoryEntityTemplateID, Inventory.Slot[] newSlots, int newSelectedSlotID, Utility.BitSet newSlotsMask, Enums.InventoryEntityType newInventoryType) {
        var index = InventoryComponentsLookup.InventoryInventoryEntity;
        var component = (Inventory.InventoryEntityComponent)CreateComponent(index, typeof(Inventory.InventoryEntityComponent));
        component.Index = newIndex;
        component.InventoryEntityTemplateID = newInventoryEntityTemplateID;
