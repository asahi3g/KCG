...
public partial class InventoryEntity {
    ...
    public void AddInventoryInventoryEntity(int newIndex, int newInventoryEntityTemplateID, Inventory.Slot[] newSlots, Utility.BitSet newSlotsMask, Enums.InventoryEntityType newInventoryType) {
    ...
    public void ReplaceInventoryInventoryEntity(int newIndex, int newInventoryEntityTemplateID, Inventory.Slot[] newSlots, Utility.BitSet newSlotsMask, Enums.InventoryEntityType newInventoryType) {
        var index = InventoryComponentsLookup.InventoryInventoryEntity;
        var component = (Inventory.InventoryEntityComponent)CreateComponent(index, typeof(Inventory.InventoryEntityComponent));
        component.Index = newIndex;
        component.InventoryEntityTemplateID = newInventoryEntityTemplateID;
