...
public class ProjectileTest : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (init)
        {
            ...
            {
                startPos = entity.agentPhysicsState.Position;
            }

            IGroup<AgentEntity> Playerentities =
            Contexts.sharedInstance.agent.GetGroup(AgentMatcher.AgentPhysicsState);
            ...
            GameState.Renderer.DrawFrame(ref projectileMeshBuilderSystem.Mesh, GameState.SpriteAtlasManager.GetSpriteAtlas(Enums.AtlasType.Particle));
