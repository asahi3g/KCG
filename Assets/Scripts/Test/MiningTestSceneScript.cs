...
namespace Planet.Unity
{
    class MiningTestSceneScript : UnityEngine.MonoBehaviour
    {
        ...
        void GenerateMap()
        {
            ...
            tileMap.SetFrontTile(6, 1, TileID.GoldBlock);
            tileMap.SetFrontTile(6, 2, TileID.GoldBlock);
            tileMap.SetFrontTile(6, 3, TileID.GoldBlock);
            tileMap.SetFrontTile(6, 4, TileID.GoldBlock);
            tileMap.SetFrontTile(6, 5, TileID.GoldBlock);
            tileMap.SetFrontTile(6, 6, TileID.GoldBlock);
            tileMap.SetFrontTile(6, 7, TileID.GoldBlock);

            tileMap.SetFrontTile(7, 1, TileID.GoldBlock);
            tileMap.SetFrontTile(7, 2, TileID.GoldBlock);
            tileMap.SetFrontTile(7, 3, TileID.GoldBlock);
            tileMap.SetFrontTile(7, 4, TileID.GoldBlock);
            tileMap.SetFrontTile(7, 5, TileID.GoldBlock);
            tileMap.SetFrontTile(7, 6, TileID.GoldBlock);
            tileMap.SetFrontTile(7, 7, TileID.GoldBlock);

            tileMap.SetFrontTile(8, 1, TileID.GoldBlock);
            tileMap.SetFrontTile(8, 2, TileID.GoldBlock);
            tileMap.SetFrontTile(8, 3, TileID.GoldBlock);
            tileMap.SetFrontTile(8, 4, TileID.GoldBlock);
            tileMap.SetFrontTile(8, 5, TileID.GoldBlock);
            tileMap.SetFrontTile(8, 6, TileID.GoldBlock);
            tileMap.SetFrontTile(8, 7, TileID.GoldBlock);

            tileMap.SetFrontTile(9, 1, TileID.GoldBlock);
            tileMap.SetFrontTile(9, 2, TileID.GoldBlock);
            tileMap.SetFrontTile(9, 3, TileID.GoldBlock);
            tileMap.SetFrontTile(9, 4, TileID.GoldBlock);
            tileMap.SetFrontTile(9, 5, TileID.GoldBlock);
            tileMap.SetFrontTile(9, 6, TileID.GoldBlock);
            tileMap.SetFrontTile(9, 7, TileID.GoldBlock);
            ...
            tileMap.SetFrontTile(10, 1, TileID.DiamondBlock);
            tileMap.SetFrontTile(10, 2, TileID.DiamondBlock);
            tileMap.SetFrontTile(10, 3, TileID.DiamondBlock);
            tileMap.SetFrontTile(10, 4, TileID.DiamondBlock);
            tileMap.SetFrontTile(10, 5, TileID.DiamondBlock);
            tileMap.SetFrontTile(10, 6, TileID.DiamondBlock);
            tileMap.SetFrontTile(10, 7, TileID.DiamondBlock);

            tileMap.SetFrontTile(11, 1, TileID.DiamondBlock);
            tileMap.SetFrontTile(11, 2, TileID.DiamondBlock);
            tileMap.SetFrontTile(11, 3, TileID.DiamondBlock);
            tileMap.SetFrontTile(11, 4, TileID.DiamondBlock);
            tileMap.SetFrontTile(11, 5, TileID.DiamondBlock);
            tileMap.SetFrontTile(11, 6, TileID.DiamondBlock);
            tileMap.SetFrontTile(11, 7, TileID.DiamondBlock);

            tileMap.SetFrontTile(12, 1, TileID.DiamondBlock);
            tileMap.SetFrontTile(12, 2, TileID.DiamondBlock);
            tileMap.SetFrontTile(12, 3, TileID.DiamondBlock);
            tileMap.SetFrontTile(12, 4, TileID.DiamondBlock);
            tileMap.SetFrontTile(12, 5, TileID.DiamondBlock);
            tileMap.SetFrontTile(12, 6, TileID.DiamondBlock);
            tileMap.SetFrontTile(12, 7, TileID.DiamondBlock);

            tileMap.SetFrontTile(13, 1, TileID.DiamondBlock);
            tileMap.SetFrontTile(13, 2, TileID.DiamondBlock);
            tileMap.SetFrontTile(13, 3, TileID.DiamondBlock);
            tileMap.SetFrontTile(13, 4, TileID.DiamondBlock);
            tileMap.SetFrontTile(13, 5, TileID.DiamondBlock);
            tileMap.SetFrontTile(13, 6, TileID.DiamondBlock);
            tileMap.SetFrontTile(13, 7, TileID.DiamondBlock);
            ...
            tileMap.SetFrontTile(14, 1, TileID.LapisBlock);
            tileMap.SetFrontTile(14, 2, TileID.LapisBlock);
            tileMap.SetFrontTile(14, 3, TileID.LapisBlock);
            tileMap.SetFrontTile(14, 4, TileID.LapisBlock);
            tileMap.SetFrontTile(14, 5, TileID.LapisBlock);
            tileMap.SetFrontTile(14, 6, TileID.LapisBlock);
            tileMap.SetFrontTile(14, 7, TileID.LapisBlock);

            tileMap.SetFrontTile(15, 1, TileID.LapisBlock);
            tileMap.SetFrontTile(15, 2, TileID.LapisBlock);
            tileMap.SetFrontTile(15, 3, TileID.LapisBlock);
            tileMap.SetFrontTile(15, 4, TileID.LapisBlock);
            tileMap.SetFrontTile(15, 5, TileID.LapisBlock);
            tileMap.SetFrontTile(15, 6, TileID.LapisBlock);
            tileMap.SetFrontTile(15, 7, TileID.LapisBlock);

            tileMap.SetFrontTile(16, 1, TileID.LapisBlock);
            tileMap.SetFrontTile(16, 2, TileID.LapisBlock);
            tileMap.SetFrontTile(16, 3, TileID.LapisBlock);
            tileMap.SetFrontTile(16, 4, TileID.LapisBlock);
            tileMap.SetFrontTile(16, 5, TileID.LapisBlock);
            tileMap.SetFrontTile(16, 6, TileID.LapisBlock);
            tileMap.SetFrontTile(16, 7, TileID.LapisBlock);

            tileMap.SetFrontTile(17, 1, TileID.LapisBlock);
            tileMap.SetFrontTile(17, 2, TileID.LapisBlock);
            tileMap.SetFrontTile(17, 3, TileID.LapisBlock);
            tileMap.SetFrontTile(17, 4, TileID.LapisBlock);
            tileMap.SetFrontTile(17, 5, TileID.LapisBlock);
            tileMap.SetFrontTile(17, 6, TileID.LapisBlock);
            tileMap.SetFrontTile(17, 7, TileID.LapisBlock);
            ...
            tileMap.SetFrontTile(18, 1, TileID.EmeraldBlock);
            tileMap.SetFrontTile(18, 2, TileID.EmeraldBlock);
            tileMap.SetFrontTile(18, 3, TileID.EmeraldBlock);
            tileMap.SetFrontTile(18, 4, TileID.EmeraldBlock);
            tileMap.SetFrontTile(18, 5, TileID.EmeraldBlock);
            tileMap.SetFrontTile(18, 6, TileID.EmeraldBlock);
            tileMap.SetFrontTile(18, 7, TileID.EmeraldBlock);

            tileMap.SetFrontTile(19, 1, TileID.EmeraldBlock);
            tileMap.SetFrontTile(19, 2, TileID.EmeraldBlock);
            tileMap.SetFrontTile(19, 3, TileID.EmeraldBlock);
            tileMap.SetFrontTile(19, 4, TileID.EmeraldBlock);
            tileMap.SetFrontTile(19, 5, TileID.EmeraldBlock);
            tileMap.SetFrontTile(19, 6, TileID.EmeraldBlock);
            tileMap.SetFrontTile(19, 7, TileID.EmeraldBlock);

            tileMap.SetFrontTile(20, 1, TileID.EmeraldBlock);
            tileMap.SetFrontTile(20, 2, TileID.EmeraldBlock);
            tileMap.SetFrontTile(20, 3, TileID.EmeraldBlock);
            tileMap.SetFrontTile(20, 4, TileID.EmeraldBlock);
            tileMap.SetFrontTile(20, 5, TileID.EmeraldBlock);
            tileMap.SetFrontTile(20, 6, TileID.EmeraldBlock);
            tileMap.SetFrontTile(20, 7, TileID.EmeraldBlock);

            tileMap.SetFrontTile(21, 1, TileID.EmeraldBlock);
            tileMap.SetFrontTile(21, 2, TileID.EmeraldBlock);
            tileMap.SetFrontTile(21, 3, TileID.EmeraldBlock);
            tileMap.SetFrontTile(21, 4, TileID.EmeraldBlock);
            tileMap.SetFrontTile(21, 5, TileID.EmeraldBlock);
            tileMap.SetFrontTile(21, 6, TileID.EmeraldBlock);
            tileMap.SetFrontTile(21, 7, TileID.EmeraldBlock);
            ...
            tileMap.SetFrontTile(22, 1, TileID.RedStoneBlock);
            tileMap.SetFrontTile(22, 2, TileID.RedStoneBlock);
            tileMap.SetFrontTile(22, 3, TileID.RedStoneBlock);
            tileMap.SetFrontTile(22, 4, TileID.RedStoneBlock);
            tileMap.SetFrontTile(22, 5, TileID.RedStoneBlock);
            tileMap.SetFrontTile(22, 6, TileID.RedStoneBlock);
            tileMap.SetFrontTile(22, 7, TileID.RedStoneBlock);

            tileMap.SetFrontTile(23, 1, TileID.RedStoneBlock);
            tileMap.SetFrontTile(23, 2, TileID.RedStoneBlock);
            tileMap.SetFrontTile(23, 3, TileID.RedStoneBlock);
            tileMap.SetFrontTile(23, 4, TileID.RedStoneBlock);
            tileMap.SetFrontTile(23, 5, TileID.RedStoneBlock);
            tileMap.SetFrontTile(23, 6, TileID.RedStoneBlock);
            tileMap.SetFrontTile(23, 7, TileID.RedStoneBlock);

            tileMap.SetFrontTile(24, 1, TileID.RedStoneBlock);
            tileMap.SetFrontTile(24, 2, TileID.RedStoneBlock);
            tileMap.SetFrontTile(24, 3, TileID.RedStoneBlock);
            tileMap.SetFrontTile(24, 4, TileID.RedStoneBlock);
            tileMap.SetFrontTile(24, 5, TileID.RedStoneBlock);
            tileMap.SetFrontTile(24, 6, TileID.RedStoneBlock);
            tileMap.SetFrontTile(24, 7, TileID.RedStoneBlock);

            tileMap.SetFrontTile(25, 1, TileID.RedStoneBlock);
            tileMap.SetFrontTile(25, 2, TileID.RedStoneBlock);
            tileMap.SetFrontTile(25, 3, TileID.RedStoneBlock);
            tileMap.SetFrontTile(25, 4, TileID.RedStoneBlock);
            tileMap.SetFrontTile(25, 5, TileID.RedStoneBlock);
            tileMap.SetFrontTile(25, 6, TileID.RedStoneBlock);
            tileMap.SetFrontTile(25, 7, TileID.RedStoneBlock);
            ...
            tileMap.SetFrontTile(26, 1, TileID.IronBlock);
            tileMap.SetFrontTile(26, 2, TileID.IronBlock);
            tileMap.SetFrontTile(26, 3, TileID.IronBlock);
            tileMap.SetFrontTile(26, 4, TileID.IronBlock);
            tileMap.SetFrontTile(26, 5, TileID.IronBlock);
            tileMap.SetFrontTile(26, 6, TileID.IronBlock);
            tileMap.SetFrontTile(26, 7, TileID.IronBlock);

            tileMap.SetFrontTile(27, 1, TileID.IronBlock);
            tileMap.SetFrontTile(27, 2, TileID.IronBlock);
            tileMap.SetFrontTile(27, 3, TileID.IronBlock);
            tileMap.SetFrontTile(27, 4, TileID.IronBlock);
            tileMap.SetFrontTile(27, 5, TileID.IronBlock);
            tileMap.SetFrontTile(27, 6, TileID.IronBlock);
            tileMap.SetFrontTile(27, 7, TileID.IronBlock);

            tileMap.SetFrontTile(28, 1, TileID.IronBlock);
            tileMap.SetFrontTile(28, 2, TileID.IronBlock);
            tileMap.SetFrontTile(28, 3, TileID.IronBlock);
            tileMap.SetFrontTile(28, 4, TileID.IronBlock);
            tileMap.SetFrontTile(28, 5, TileID.IronBlock);
            tileMap.SetFrontTile(28, 6, TileID.IronBlock);
            tileMap.SetFrontTile(28, 7, TileID.IronBlock);

            tileMap.SetFrontTile(29, 1, TileID.IronBlock);
            tileMap.SetFrontTile(29, 2, TileID.IronBlock);
            tileMap.SetFrontTile(29, 3, TileID.IronBlock);
            tileMap.SetFrontTile(29, 4, TileID.IronBlock);
            tileMap.SetFrontTile(29, 5, TileID.IronBlock);
            tileMap.SetFrontTile(29, 6, TileID.IronBlock);
            tileMap.SetFrontTile(29, 7, TileID.IronBlock);
            ...
            tileMap.SetFrontTile(30, 1, TileID.CoalBlock);
            tileMap.SetFrontTile(30, 2, TileID.CoalBlock);
            tileMap.SetFrontTile(30, 3, TileID.CoalBlock);
            tileMap.SetFrontTile(30, 4, TileID.CoalBlock);
            tileMap.SetFrontTile(30, 5, TileID.CoalBlock);
            tileMap.SetFrontTile(30, 6, TileID.CoalBlock);
            tileMap.SetFrontTile(30, 7, TileID.CoalBlock);

            tileMap.SetFrontTile(31, 1, TileID.CoalBlock);
            tileMap.SetFrontTile(31, 2, TileID.CoalBlock);
            tileMap.SetFrontTile(31, 3, TileID.CoalBlock);
            tileMap.SetFrontTile(31, 4, TileID.CoalBlock);
            tileMap.SetFrontTile(31, 5, TileID.CoalBlock);
            tileMap.SetFrontTile(31, 6, TileID.CoalBlock);
            tileMap.SetFrontTile(31, 7, TileID.CoalBlock);

            tileMap.SetFrontTile(32, 1, TileID.CoalBlock);
            tileMap.SetFrontTile(32, 2, TileID.CoalBlock);
            tileMap.SetFrontTile(32, 3, TileID.CoalBlock);
            tileMap.SetFrontTile(32, 4, TileID.CoalBlock);
            tileMap.SetFrontTile(32, 5, TileID.CoalBlock);
            tileMap.SetFrontTile(32, 6, TileID.CoalBlock);
            tileMap.SetFrontTile(32, 7, TileID.CoalBlock);

            tileMap.SetFrontTile(33, 1, TileID.CoalBlock);
            ...
            tileMap.SetFrontTile(34, 1, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(34, 2, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(34, 3, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(34, 4, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(34, 5, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(34, 6, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(34, 7, TileID.PinkDiaBlock);

            tileMap.SetFrontTile(35, 1, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(35, 2, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(35, 3, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(35, 4, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(35, 5, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(35, 6, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(35, 7, TileID.PinkDiaBlock);

            tileMap.SetFrontTile(36, 1, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(36, 2, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(36, 3, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(36, 4, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(36, 5, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(36, 6, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(36, 7, TileID.PinkDiaBlock);

            tileMap.SetFrontTile(37, 1, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(37, 2, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(37, 3, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(37, 4, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(37, 5, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(37, 6, TileID.PinkDiaBlock);
            tileMap.SetFrontTile(37, 7, TileID.PinkDiaBlock);
