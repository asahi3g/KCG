...
namespace Planet.Unity
{
    public class AimAITest : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            {
                GameState.ActionCreationSystem.CreateTargetAction(Planet.EntitasContext, Enums.ActionType.ToolActionFireWeapon, Marine.agentID.ID, Target.agentID.ID, item.itemID.ID);
