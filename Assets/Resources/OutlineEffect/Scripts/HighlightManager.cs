...
namespace HighlightPlus {
    ...
    public class HighlightManager : MonoBehaviour {
        ...
        void Update() {
            ...
            RaycastHit hitInfo;
            if (UnityEngine.Physics.Raycast(ray, out hitInfo, maxDistance > 0 ? maxDistance : raycastCamera.farClipPlane, layerMask) && Vector3.Distance(hitInfo.point, ray.origin) >= minDistance) {
